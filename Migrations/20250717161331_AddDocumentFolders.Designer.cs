...
namespace IntranetDocumentos.Migrations
{
    ...
    [Migration("20250717161331_AddDocumentFolders")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IntranetDocumentos.Models.DocumentFolder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("IntranetDocumentos.Models.Document", b =>
                {
                    ...
                    b.HasOne("IntranetDocumentos.Models.DocumentFolder", "Folder")
                        .WithMany("Documents")
            ...
            modelBuilder.Entity("IntranetDocumentos.Models.DocumentFolder", b =>
                {
                    b.HasOne("IntranetDocumentos.Models.ApplicationUser", "CreatedBy")
                        .WithMany()
                    ...
                    b.HasOne("IntranetDocumentos.Models.DocumentFolder", "ParentFolder")
                        .WithMany("ChildFolders")
                        .HasForeignKey("ParentFolderId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("IntranetDocumentos.Models.ApplicationUser", "UpdatedBy")
                        .WithMany()
